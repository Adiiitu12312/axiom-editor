...
import { 
  ...
  Video as YoutubeIcon, MessageSquare as Twitter, Camera as Instagram, MessageSquareWarning, Code, CheckSquare
} from 'lucide-react';
import { useAxiomEditor } from '../core/AxiomEditorContext';
import { ToolbarButton } from './ToolbarButton';

export const AxiomToolbar: React.FC = () => {
  const { editor, isSaved, setMediaModalOpen, setMediaModalType, setMediaModalInput } = useAxiomEditor();
